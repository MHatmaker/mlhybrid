...
(function () {
    ...
    define([
        ...
        function mobileInit(mpmod) {
            var watchOptions,
                watch;
            console.log("in MapCtrl mobileInit");

            mpmod.controller('MapCtrl', function ($scope, $state, $cordovaGeolocation, $ionicLoading, $ionicPlatform) {
        ...
        function browserInit(mpmod) {
            var watchOptions,
                watch,
                MapCtrl;
            console.log("in MapCtrl browserInit");

            MapCtrl = mpmod.controller('MapCtrl', function ($rootScope, $scope, $state) {
        ...
        function init(App, isMob) {
            ...
            if (isMob) {
                MapCtrl = mobileInit(App);
            } else {
                MapCtrl = browserInit(App);
            }
            return MapCtrl;
        }
        return {
